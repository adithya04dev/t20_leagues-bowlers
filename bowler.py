...
# #result=bow.calculateb(["Indian Premier League"],'TA Boult',[1,2,3],["RHB"],[2021,2022,2023]) 

# #print(result)

# with open('C:/Users/adith/Documents/ds/all_t20_app/individual/bowling_n/bowling2.pkl', 'wb') as f:
#         pickle.dump(bow, f)
